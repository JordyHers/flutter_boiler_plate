...
class BoilerPlateRep implements BoilerPlateRepository{
 ...
 @override
  Future<List<Album>> getRemoteAlbums () async => await boilerJsonSource.getRemoteAlbumList();

 @override
  Future<List<Photo>> getRemotePhotos () async => await boilerJsonSource.getRemotePhotoList();
